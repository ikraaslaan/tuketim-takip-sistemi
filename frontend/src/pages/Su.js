    ...
    <div className="pt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-12">
      <div className="animate-fade-in">
        ...
        {selectedNeighborhoodName && chartData.length > 0 && !dataLoading && (
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-blue-100/50 chart-container">
            <h3 className="text-base font-semibold mb-4 text-gray-800">{selectedNeighborhoodName} - Su Tüketim Trendi (m³)</h3>
